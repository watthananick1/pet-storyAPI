...
import serviceAccount from "../pet-story-f51e3-appFirebase-adminsdk-wsths-b452f92272.json" assert { type: "json" };
import appFirebase from 'appFirebase/compat/app';
import 'appFirebase/compat/auth';
import 'appFirebase/compat/firestore';
import crypto from 'crypto';
import {appappFirebase, db} from "./models/appFirebase.js"
...
router.post('/register', async (req, res) => {
  try {
    ...
    const { user } = await appappFirebase.auth().createUserWithEmailAndPassword(req.body.email, req.body.password);
