...
router.post("/comment/:postId", async (req, res) => {
  try {
    ...
    const res2 = await postRef.updateData({
      comment: FieldValue.arrayUnion(commentId),
    });
    ...
    console.log('res3',commentsSnapshot);
    ...
    return res
      .status(500)
      .json({ message: "Failed to create comment", error: err , comments});
  }
});
