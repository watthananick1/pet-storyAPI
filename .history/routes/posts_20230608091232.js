...
router.get("/user/:firstName", async (req, res) => {
  try {
    ...
    [index].firstName = user.firstName; // Add firstName to comment
    [index].lastName = user.lastName; // Add lastName to comment
    [index].profilePicture = user.profilePicture; // Add profilePicture to comment
