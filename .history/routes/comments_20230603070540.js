...
router.get('/:postId/Comments', async (req, res) => {
  try {
    ...
    const commentsSnapshot = await commentCollection.doc('postId', '==', postId).get();
    // const commentsRef = commentsSnapshot.where('postId', '==', postId).get();
    console.log('Comment',commentsSnapshot);
