...
import { appFirebase, db, storage, collection as postCollection } from "../routes/firebase.js";
import { collection as userCollection } from 'firebase/firestore';


const postsCollection = collection(db, "Posts");
const postsCollection = collection(db, "User");
 ...
 // Get posts for a specific member with sorting options
  router.get('/:id/:sort', async (req, res) => {
    try {
      ...
      const queryUserSnapshot = await userCollection.where('member_id', '==', memberId).get();
