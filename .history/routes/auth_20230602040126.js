...
router.post('/register', async (req, res) => {
  try {
    ...
    const { user } = await getAuth.createUserWithEmailAndPassword(req.body.email, req.body.password);
    ...
    await collection(db,'Users',user.uid).doc(user.uid).setDoc(userData);
