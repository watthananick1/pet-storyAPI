...
router.get('/:id/:sort', async (req, res) => {
  try {
    ...
    console.log(users.filter(user => user.typePets));
    ...
    } else if (sortParam === 'typePets') {
      // Sort by typePets in ascending order
      posts.sort((a, b) => a.typePets.localeCompare(b.typePets));
    } else {
