...
router.post("/comment/:postId", async (req, res) => {
  try {
    ...
    const newComment = {
      id:  FieldValue.arrayUnion([removeSpaces(deviceId)]),,
      postId: postId,
    ...
    const res2 = await postRef.set({
      comment:  FieldValue.arrayUnion([removeSpaces( FieldValue.arrayUnion([removeSpaces(deviceId)]),)]),
