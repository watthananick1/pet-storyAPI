...
router.post('/register', async (req, res) => {
  try {
    ...
    const { user } = await getAuth(appFirebase).createUserWithEmailAndPassword(req.body.email, req.body.password);
    ...
    await collection(db,"Users",user.uid).setDoc(userData);
